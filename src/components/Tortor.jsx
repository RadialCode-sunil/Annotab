    ...
    return (
        <div className=' position-relative py-5'>
            <div className='z_index_1 max_width_876  d-inline-block position-absolute top-50 start_50  translate_middle  transform_y__50  text-center'>
                        <p className=' ff_Medium  fs_3xl fw_400 white  p-3 p-lg-0 '>Tortor nisi amet aliquam fermentum. Elementum orci sit mi nunc ac. Aliquam eget cras felis id feugiat.</p>
            ...
            <marquee direction="right" height="100%" className=' w-100  d-flex'>
                <img className=' img-fluid height_100 ' src={tortor_1} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_2} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_3} alt="" />
                <img className=' img-fluid height_100' src={tortor_3} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_3} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_3} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_3} alt="" />
            ...
            <marquee direction="left" height="100%" className=' w-100 d-flex tortor_1'>
                <img className=' img-fluid height_100 ' src={tortor_4} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_5} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_6} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_6} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_6} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_6} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_6} alt="" />
            ...
            <marquee direction="right" height="100%" className='  d-flex top_84 start-0 '>
                <img className=' img-fluid height_100 ' src={tortor_7} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_8} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_9} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_10} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_10} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_10} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_10} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_10} alt="" />
            ...
            <marquee direction="left" height="100%" className='  d-flex top_126 end-0 '>
                <img className=' img-fluid height_100 ' src={tortor_11} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_12} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_13} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_13} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_13} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_13} alt="" />
                <img className=' img-fluid height_100 ' src={tortor_13} alt="" />
