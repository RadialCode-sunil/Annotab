...
export const Latest = () => {
    ...
    return (
        <section className=' py-3 py-lg-5 mb-lg-5 position-relative'>
            ...
            <Container>
                ...
                <div className=' text-center justify-content-center d-flex align-items-center flex-column pt-3 pt-lg-5'>
                    <div className='d-flex align-items-center mb-5 border_bottom_latest'>
                        <p className=' ff_Medium  fs_xl grey fw_400 mb-0 pe-2 pe-md-5 border_bottom_1 pointer'>Basic plans</p>
                ...
                <div className=' text-center pt-5 mt-lg-5'>
