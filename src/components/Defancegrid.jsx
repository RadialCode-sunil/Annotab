...
export const Defancegrid = () => {
    return (
        <div>
            <Exploreaerospaces max="max_width_704" Aerospace="Explore Aerospace & Defense Use Cases" gridimg1={aeroplane1} gridimg2={aeroplane2} gridimg3={aeroplane3} gridimg4={aeroplane4} gridimg5={aeroplane5} gridimg6={aeroplane6} />
        </div>
    )
}
