...
export const Explorebanking = () => {
    return (
        <Container>
            <div>
                <Sliderprops heading="Explore Banking & Finance Use Cases" para="Scelerisque integer egestas nunc egestas. Vestibulum nunc blandit ultrices sit sagittis rutrum sed felis in ullamcorper adipiscing." sliderimg={exploreimg4} sliderimg2={exploreimg5} sliderimg3={exploreimg6} smallheading1="Libero" smallheading2="Ut ipsum" smallheading3="Vitae nibh" />
            </div>
